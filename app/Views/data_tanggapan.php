    ...
    <main class="relative z-10 flex-grow flex flex-col items-center pt-8 pb-12 px-4 w-full">
        ...
        <div class="w-full max-w-6xl bg-white rounded-xl shadow-2xl overflow-hidden p-6 md:p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <button class="bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 px-4 py-2 rounded-md font-semibold text-sm transition shadow-sm flex items-center space-x-2">
